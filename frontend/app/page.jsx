        ...
        <div className="max-w-6xl mx-auto"> 
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
            <div className="flex-1 text-center md:text-left">
              <Badge 
                variant="outline"
                className="border-2 border-orange-600 text-orange-700 bg-orange-50 
              ...
              <p className="text-xl md:text-2xl text-stone-600 mb-10 max-w-lg max-aut0 md:max-0 font-light">
                Snap a photo of your fridge. We&apos;ll tell you what to cook.
                save money, reduce waste, and better tonight.
              </p>
            ...
            >
              ...
              {/* Floating Card */} 
              <Card className="absolute bottom-8 left-8 right-8 bg-white/80
              backdrop-blur-sm border-2 border-stone-900 py-0">
                <CardContent className="p-4">
                  ...
                  <div className="flex gap-4 text-xs text-stone-500 font-medium">
                    ...
                    <span className="flex items-center gap-1">
                      <Clock className="w-3 h-3" /> 25mins
                    </span>
                    <span className="flex items-center gap-1">
                      <User className="w-3 h-3" /> 2 servings
                    </span>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {FEATURES.map((feature, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="border-2 border-stone-200 bg-orange-50 hover:border-orange-600 hover:shadow-lg transition-all group py-0"
                >
