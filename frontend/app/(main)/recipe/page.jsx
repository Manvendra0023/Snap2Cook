            ...
            <div className="mt-8 max-w-md mx-auto">
              <div className="flex items-center gap-3 text-sm text-stone-500">
                <div className="flex-1 h-1 bg-stone-200 overflow-hidden relative">
                  <div
                    className="absolute left-0 top-0 h-full bg-orange-600 transition-all duration-200"
                ...
                <div key={category} className="mb-6 last:mb-0">
                  ...
                  <ul className="space-y-2">
                    {items.map((ingredient, i) => (
                      <li
                        key={i}
                        className="grid grid-cols-[1fr_auto] gap-3 text-stone-700 py-2 border-b border-stone-100 last:border-0"
                      >
                        <span className="break-words">
                          {ingredient.item}
                        </span>

                        <span className="font-bold text-orange-600 text-sm text-right break-words">
                          {ingredient.amount}
                        </span>
                      </li>
                    ))}
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-orange-50 p-3 text-center border-2 border-orange-100">
                        <div className="text-2xl font-bold text-stone-900">
                          {recipe.nutrition.calories?.replace("Approximately", "")}
                        </div>
                      ...
                      <div className="bg-stone-50 p-3 text-center border-2 border-stone-100">
                        <div className="text-2xl font-bold text-stone-900">
                          {recipe.nutrition.protein?.replace("Approximately", "")}
                        </div>
                        <div className="text-xs text-stone-500 font-bold uppercase tracking-wide">
                          Protein
                        </div>
                      ...
                      <div className="bg-stone-50 p-3 text-center border-2 border-stone-100">
                        <div className="text-2xl font-bold text-stone-900">
                          {recipe.nutrition.carbs?.replace("Approximately", "")}
                        </div>
                        <div className="text-xs text-stone-500 font-bold uppercase tracking-wide">
                          Carbs
                        </div>
                      ...
                      <div className="bg-stone-50 p-3 text-center border-2 border-stone-100">
                        <div className="text-2xl font-bold text-stone-900">
                          {recipe.nutrition.fat?.replace("Approximately", "")}
                        </div>
                        <div className="text-xs text-stone-500 font-bold uppercase tracking-wide">
                          Fat
                        </div>
